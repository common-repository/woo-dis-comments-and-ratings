...
class Zamartz_Settings
{
	...
	public function init()
	{
		...
		$this->zamartz_settings_path = $base_plugin_path . '/zamartz/settings';
	...
	public function get_page_content($current_tab, $current_section)
	{
		...
		require_once $this->zamartz_settings_path . "/class-zamartz-settings-{$current_tab}.php";

		//Dynamically define class name
		$class_name = 'Zamartz_Settings_' . ucfirst($current_tab);
