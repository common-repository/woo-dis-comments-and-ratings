...
/**
 * The Zamartz admin add-on settings specific functionality of the plugin. 
...
class Zamartz_Settings_Addons
{
	...
	{
		$addon_settings = apply_filters('zamartz_admin_addon_settings', $addon_settings);
	 ...
	 * @since    1.0.0
	 */
	public function get_addon_information($addon_settings = array())
	{
		$addon_information = apply_filters('zamartz_admin_addon_information', $addon_settings);
